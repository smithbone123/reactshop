...
import {Heading, FooterMenu, CountrySelector} from '~/components';
...
export function Footer({menu}) {
  ...
  return (
    <footer
      ...
      className="bg-white pt-4 sm:pt-6 lg:pt-8"
    >
      <div className="pt-12">
        <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          {/*  */}

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 mb-16 border-t py-8">
            <div className="col-span-full lg:col-span-2">
              ...
              {/* Country */}
              <section className="lg:-mt-2 mb-4">
